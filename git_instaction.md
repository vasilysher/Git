...
Во этом варианте все данные необходимо загружать из корневой папки. В ином случае может быть ошибка или файл не уйдет по назначению.
...
* touch (имя нового файла) - создание нового файла в репозитории.
