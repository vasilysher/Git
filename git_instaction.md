...
Отработав нужные изменения отправляем измененный файл на свой аккаунт в github.com и затем командой **pull request** направляем изменения владелюцу репозитория в котором мы внесли изменеия.
