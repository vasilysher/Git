...
После проведения необходимых изменений в локальном файле необходимо добавить все изменения на сервер, это производится командой ***git push***. Отмечаю, что в этот момен должен быть выполнен вход в githud.com в основном браузере на вашем компютере. 
